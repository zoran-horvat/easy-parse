...
namespace ParserCompiler.Collections
{
    public class State : IEquatable<State>
    {
        ...
        private State(Set<Rule> rules, IEnumerable<StateElement> elements)
        {
            this.Rules = rules;
        ...
        public IEnumerable<State> Advance() =>
            this.Elements
                ...
                .Select(group => new State(this.Rules, group))
                .Select(state => state.Closure());

        private State Expand() =>
            this.Elements
                .SelectMany(element => element.PeekNonTerminal())
        ...
        private State Append(StateElement element) =>
            new State(this.Rules, this.AppendToElements(element));
